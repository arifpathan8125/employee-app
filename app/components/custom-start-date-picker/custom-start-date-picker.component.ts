...
@Component({
  selector: "app-custom-start-date-picker",
  templateUrl: './custom-start-date-picker.component.html',
  styleUrls: ['./custom-start-date-picker.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class CustomStartDatePickerComponent {
  ...
  onDateChange(event: any) {
    this.commonService.setSelectedStartDate(event.value);
  }
}
...
<div class="container">
  <div class="row mt-2">
    <div class="col cal-btn" (click)="dateBtnClicked()">Today</div>
    <div class="col cal-btn" (click)="dateBtnClicked('monday')">Next Monday</div>
  </div>
</div>
<div class="container">
  <div class="row">
    <div class="col cal-btn" (click)="dateBtnClicked('tuesday')">Next Tuesday</div>
    <div class="col cal-btn" (click)="dateBtnClicked('week')">After 1 week</div>
  </div>
</div>
...
export class DatePickerHeader<D> implements OnDestroy {
  ...
  dateBtnClicked(label?: any) {
    ...
    this.commonService.setSelectedStartDate(date);
